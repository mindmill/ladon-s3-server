...
import de.mc.ladon.s3server.auth.AWS4SignerBase;
import de.mc.ladon.s3server.auth.AWS4SignerForAuthorizationHeader;
import de.mc.ladon.s3server.util.BinaryUtils;
import de.mc.ladon.s3server.util.HttpUtils;
